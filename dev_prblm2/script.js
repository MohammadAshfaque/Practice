...
.then(result => {
    ...
    document.querySelector("#parent").innerHTML+= `<div class="card w-60 p-4 rounded-xl bg-zinc-800">
            ...
            <h6 class="text-semibold opacity-40">${email}</h6>
            <p  class="mt-5 text-xs font-semibold opacity-80">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quibusdam quaerat similique quia nesciunt!</p>
        </div>`;
})
}
